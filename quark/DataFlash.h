 ...
 **/
        ...
        **/
        void WriteIntoDevice(uint8_t* val, uint8_t buffer, uint16_t size, uint16_t page, uint16_t offset);

        /**
         * Read data from one Page(256 bytes) from Data flash
